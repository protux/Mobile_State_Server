# Generated by Django 2.1.1 on 2018-11-10 18:35
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='phone',
            name='attached_power_socket',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='phone.PowerSocket'),
        ),
        migrations.AddField(
            model_name='phone',
            name='owner',
        ...
        migrations.AlterUniqueTogether(
            name='powersocket',
            unique_together={('owner', 'label'), ('namespace', 'socket_id')},
        ),
        migrations.AlterUniqueTogether(
            name='phone',
            unique_together={('owner', 'label')},
